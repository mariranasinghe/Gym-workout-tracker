...
export const exercises: Exercise[] = [
  // CHEST
  {
    ...
    tips: ['Keep your shoulder blades pinched together', 'Maintain a slight arch in your lower back'],
  },
  {
  ...
  },
  {
    ...
    equipment: 'dumbbell',
    instructions: [
      'Lie on bench with arms extended above chest',
      'Lower dumbbells in an arc motion',
      'Feel the stretch in your chest',
      'Bring back up squeezing chest',
    ],
  },
  {
    id: 'cable-crossover',
    ...
    instructions: [
      ...
      'Grab handles with arms out wide',
      'Bring hands together in front of chest',
      'Squeeze and slowly return',
    ],
  },
  {
    id: 'push-ups',
  ...
  // BACK
  {
    ...
    tips: ['Keep bar close to body', 'Engage lats before lifting'],
  },
  {
    id: 'barbell-row',
    name: 'Barbell Row',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Pull to midsection squeezing back',
      'Return with control',
    ],
  },
  {
    ...
    instructions: [
      ...
      'Pull to hip keeping elbow close',
      'Lower with control',
    ],
  },
  {
  ...
  },
  {
    ...
    equipment: 'bodyweight',
    instructions: [
      'Grip parallel bars with body upright',
  ...
  // LEGS
  {
    ...
    tips: ['Keep chest up', 'Push knees out over toes'],
  },
  {
    id: 'front-squat',
    name: 'Front Squat',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Face machine and brace yourself',
      'Kick leg back keeping it straight',
  ...
  },
  {
    ...
    equipment: 'bodyweight',
    instructions: [
      'Lie on back with arms up and knees bent 90°',
...
export function getExercisesByMuscleGroup(muscleGroup: string): Exercise[] {
  ...
  return exercises.filter(e => e.muscleGroup === muscleGroup || e.secondaryMuscles?.includes(muscleGroup as any))
}
